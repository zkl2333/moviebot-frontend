...
const Index = () => {
  return (
    <div className="mx-auto text-center">
      <div className="mx-auto space-y-6 mb-6 max-w-4xl">
        <div className="text-xs font-bold text-green-400">INCLUDED IN ALL PLANS</div>
        <div className="text-5xl font-bold">All The TV You Love</div>
      ...
      <div className="mx-auto grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 max-w-7xl">
        {mediaLibraryList.map((item, index) => {
          return (
            ...
            >
              ...
              {/* 上下阴影 文字在上 */}
              <div
                className="absolute inset-0 space-y-2 text-start p-4
              ...
              >
                <div className="text-xl font-semibold text-white">{item.description}</div>
                <div className="text-3xl font-bold text-white">{item.name}</div>
              </div>
            </div>
          );
        })}
